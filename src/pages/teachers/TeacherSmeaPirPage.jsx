...
export default function TeacherSmeaPirPage() {
  const [activeTab, setActiveTab] = useState('dashboard')

  return (
    <DashboardLayout
      activePath="/teachers/smea-pir"
      ...
      contextText="Teacher / Adviser • Class Management • Scope: SMEA/PIR"
          ...
          {activeTab === 'dashboard' && (
            <div>
              <div className="smea-page-header">
                ...
                <button className="smea-btn smea-btn-primary" onClick={() => setActiveTab('submission')}>Submit PIR Report ↗</button>
              </div>
              ...
              <div className="smea-section-card">
                ...
                <table className="smea-data-table">
                  ...
                  <tbody>
                    ...
                    <tr><td>Grade 3–6</td><td>All core subjects</td><td>—</td><td>—</td><td>—</td><td style={{color:'#6B7280',fontSize:'11px'}}>Encode data below</td></tr>
                  </tbody>
                </table>
                <button className="smea-btn smea-btn-primary" style={{marginTop:'10px',fontSize:'12px'}}>Encode MPS data ↗</button>
              </div>
            </div>
          )}
          ...
          {activeTab === 'submission' && (
            <div>
              ...
              <div className="smea-stepper">
                ...
                <div className="smea-step-line"></div>
                <div className="smea-step"><div className="smea-step-circle">5</div> Review &amp; submit</div>
              </div>
